...
public class DialogUtils {
    ...
    public void show(AlertDialogListener listener, String title, String content,String positive){
        showAlertDialog(listener,title,content,positive);
    }
    //加载中弹框
    ...
    //两行提示框自定义文言
    private  void showAlertDialog(final AlertDialogListener listenerString,String hint1,String hint2,String positive){
        LayoutInflater inflater = LayoutInflater.from(mContext);

        View contentView = inflater.inflate(R.layout.alert_dialog, null);

        ((TextView)(contentView.findViewById(R.id.tv_cancle))).setVisibility(View.GONE);
        ((TextView)(contentView.findViewById(R.id.tv_confirm))).setText(positive);

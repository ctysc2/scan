...
public class CalendarDateView extends ViewPager implements CalendarTopView {
    ...
    private CalendarViewCreatedListener mViewCreatedListener;
    private LinkedList<CalendarView> cache = new LinkedList();
    private CalendarOnPageChangedListener mOnPageChangedListener;
    ...
    public void setOnPageChangedListener(CalendarOnPageChangedListener listener){
        mOnPageChangedListener = listener;
    }
    public void setOnCalenderViewCreatedListener(CalendarViewCreatedListener listener){
    ...
    private PagerAdapter mPagedAdapter = new PagerAdapter() {
        @Override
        public int getCount() {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if(mViewCreatedListener != null){
                ...
                mViewCreatedListener.onViewCreated(view,beanList);
            }
    ...
    public PagerAdapter getAdapter(){
        return mPagedAdapter;
    }
    private void init() {


        setAdapter(mPagedAdapter);
...
//                }
                ...
                if(mOnPageChangedListener != null){
                    CalendarView view = views.get(position);
                    mOnPageChangedListener.onPageChanged(position,view.getData().get(10));
                }
    ...
    public void update(){
        ...
        while (iter.hasNext()) {
            ...
            ((CalendarView)entry.getValue()).setItem();
        }
    }
}
